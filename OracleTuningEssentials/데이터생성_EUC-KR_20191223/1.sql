...
-- 테이블 스페이스 생성
CREATE TABLESPACE MY_DATA DATAFILE 'D:\Oracle\ORADATA\MY_DATA01.dbf' SIZE 30G AUTOEXTEND ON;
ALTER TABLESPACE MY_DATA ADD DATAFILE 'D:\Oracle\ORADATA\MY_DATA02.dbf' SIZE 30G AUTOEXTEND ON; --  NEXT 50M MAXSIZE 2048M;
ALTER TABLESPACE MY_DATA ADD DATAFILE 'D:\Oracle\ORADATA\MY_DATA03.dbf' SIZE 30G AUTOEXTEND ON; --  NEXT 50M MAXSIZE 2048M;
